...
class ShowIndividualInfoPage extends StatefulWidget {
  const ShowIndividualInfoPage({Key? key, required this.patientID, required this.patientName}) : super(key: key);
  final String patientID;
  final String patientName;

  @override
  State<ShowIndividualInfoPage> createState() => _ShowIndividualInfoPageState();
}

class _ShowIndividualInfoPageState extends State<ShowIndividualInfoPage> {
  ...
  void initState() {
    super.initState();
    if (widget.patientName != "未命名") setState(() => submitstate = true);
    _initConfig();
  }

  void _initConfig() async {
    if (submitstate) await GetPatientInfo(context);
  }
